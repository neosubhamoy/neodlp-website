        ...
        <section className="flex flex-col w-full min-h-screen">
            <BackgroundLines className="flex flex-col w-full h-full">
                ...
                <div className="flex flex-col items-center justify-center text-center gap-10 z-20">
                    <div className="grid grid-cols-1 sm:flex sm:flex-wrap justify-center items-center gap-4 mt-10 sm:max-w-[70%] lg:max-w-[50%]">
                        <SlidingButton
                            slidingContent={
                        ...
                        <SlidingButton
                            ...
                            as="a"
                            href={release.platforms["linux-aarch64-rpm"].url}
                            target="_blank"
                            >
                            <span className="font-semibold flex items-center gap-2">
                                <svg className="size-4 fill-white dark:fill-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                        ...
                        <SlidingButton
                            ...
                            as="a"
                            href={release.platforms["linux-x86_64+aarch64-aur"].url}
                            target="_blank"
                            >
                            <span className="font-semibold flex items-center gap-2">
                                <svg className="size-4 fill-white dark:fill-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
